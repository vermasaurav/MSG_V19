...
const Section7 = () => {
  ...
  return (
    <div className='flex bg-gradient-to-br from-blue-900 via-blue-800 to-black h-auto min-h-[60vh] justify-center items-center p-4'>
      <div className='w-full max-w-[80%] flex flex-col md:flex-row justify-around items-center'>
        <div className='w-full md:w-[25rem] mt-9 text-center md:text-left'>
          <div>
            <div className='font-outfit text-2xl md:text-3xl text-white'>Send Your First</div>
            <Typingeffect texts={texts} speed={100} />
            <div className='font-outfit text-2xl md:text-3xl text-white mt-2'>in a matter of minutes</div>
          </div>
          <div className='mt-5 text-white font-semibold text-sm md:text-xl'>
            Register now for a MSG24x7 account to get started. Send your first text message, OTP Code, or WhatsApp messages in minutes and when you're ready to upgrade, contact our expert.
          </div>
        </div>

        <div className='flex flex-col justify-start items-center mt-6 md:mt-0'>
          <div className='flex justify-between items-center w-full max-w-[15rem]'>
            <button className='text-white font-inter bg-blue-950 border-2 border-white p-1 rounded-md px-2'>WhatsApp</button>
            <button className='text-white font-inter bg-blue-950 border-2 border-white p-1 rounded-md px-2'>SMS</button>
          </div>
          <div className='bg-black w-full max-w-[20rem] h-auto p-3 rounded-xl mt-2 border-2 border-white overflow-x-auto'>
            <pre className='text-xs text-white'>{JSON.stringify(jsonData, null, 2)}</pre>
          </div>
        </div>
      </div>
    </div>
