...
const Section2 = () => {
  ...
  return (
    <>
    <div className='h-auto w-full bg-gradient-to-br from-orange-400 via-orange-300 to-orange-400 '>
    <div className='flex justify-center items-center'>
    {/* <div className='text-center inline-block bg-gradient-to-bl from-orange-800 via-orange-500 to-orange-800 p-2 mt-3 rounded-md font-inria-sans text-2xl text-white font-bold px-15 border-2 border-white'>SMS Services</div> */}
    ...
    <h2 class="md:text-[2rem] sm:text-[1.5rem] font-bold tracking-wider -mt-3 text-white ">SMS Services</h2>
</div>
    </div>
    <div className='flex justify-center items-center'>
   ...
   {content[category].map((item, index) => (
    ...
    <div><button className='bg-orange-700 text-white font-inria-sans p-1 px-10 rounded-md border-b-4 border-r-4 border-orange-500'>Sign Up for free</button></div>
    </div>
    <div><img src={Banner4} className='w-[25rem] h-[25rem]' data-aos="zoom-in"/></div>
    </div>
    </div>
    </div>
