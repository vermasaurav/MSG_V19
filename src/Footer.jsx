...
import { FaFacebook, FaInstagram, FaWhatsapp, FaYoutube } from "react-icons/fa";
import FooterImage from "./assets/footerImage.png"; // Ensure this path is correct

export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-blue-900 to-black text-white py-10 px-6 md:px-20">
      <div className="container mx-auto grid md:grid-cols-4 gap-10 items-center">
        
        {/* Footer Image */}
        <div className="hidden md:block">
          <img src={FooterImage} alt="Footer Logo" className="w-40 h-auto" />
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>WhatsApp Chat Button Generator</li>
            <li>WhatsApp QR Code Generator</li>
          </ul>
          <h2 className="text-lg font-bold mt-5 mb-3">IT Services</h2>
          <ul className="space-y-2">
        ...
        <div>
          ...
          <div className="mt-5 flex space-x-4">
            <img src="/iso9001.png" alt="ISO 9001 Certified" className="w-16" />
            <img src="/iso27001.png" alt="ISO 27001 Certified" className="w-16" />
          </div>
        </div>
      </div>
      ...
      <div className="mt-10 text-center border-t border-gray-700 pt-5">
        ...
        <p className="mt-5 text-xs">
          Copyright &copy; 2025 - MSG24x7 Communications powered by{" "}
          <span className="text-blue-400">DIGINTRA INC</span> – All rights reserved
        </p>
      </div>
    </footer>
  );
